...
exports.setupConsolidationModule = void 0;
const express_1 = require("express");
const consolidationRouter = (0, express_1.Router)();
const setupConsolidationModule = (executarQuery) => {
    /**
     * POST /api/consolidation/gate-checkin - Handshake de entrada Bruta
     */
    consolidationRouter.post('/gate-checkin', async (req, res) => {
     ...
     */
    consolidationRouter.post('/esteira-triagem', async (req, res) => {
     ...
     */
    consolidationRouter.get('/:id/mass-balance', async (req, res) => {
...
exports.setupConsolidationModule = setupConsolidationModule;
